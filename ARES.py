...
def phoneGW():
    User_phone = input(
        f"\n {Wh}phone Number target {Blu}[+6281xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
...
def execute_option(opt):
    try:
        call_option(opt)
        input(f'\n{Wh} {Cy} silahkan enter untuk melanjutkan')
        main()
...
def option():
   ...
   __    ____  ____  ___    _____  ___  ____  _  _  ____  V1
  /__\  (  _ \( ___)/ __)  (  _  )/ __)(_  _)( \( )(_  _)
 /(__)\  )   / )__) \__ \   )(_)( \__ \ _)(_  )  (   )(  
(__)(__)(_)\_)(____)(___/  (_____)(___/(____)(_)\_) (__) 
         {Re} pembuat : manzxploit , kolonial443
               {Re} team : CYBER EROR SYSTEM
...
def main():
    ...
    try:
        ...
        print(f'\n{Wh}[ {Re}! {Wh}] {Re}Silahkan Pilih Nomer')
        time.sleep(2)
        main()
...
if __name__ == '__main__':
    try:
        ...
        print(f"{Re}SAMPAI JUMPA KEMBALI BAY")
        print(f'\n{Wh}[ {Re}! {Wh}] {Re}Exit')
        time.sleep(2)
        print(f"{Re}SAMPAI JUMPA KEMBALI BAY")
        exit()